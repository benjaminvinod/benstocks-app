...
function Dashboard() {
    ...
    const tourSteps = [
        {
          target: '#cash-balance',
          content: 'This is your available cash balance. Use it to buy stocks and funds!',
          placement: 'bottom',
        },
        {
          target: '#stock-checker-form',
          content: 'You can search for any stock here. Try "AAPL" for Apple or "RELIANCE.NS" for Reliance.',
          placement: 'bottom',
        },
        {
          target: '#holdings-section',
          content: 'Once you buy stocks, they will appear in this section.',
          placement: 'top',
        },
      ];
    ...
    return (
        <div className="container">
            ...
            {transactionsError ? <p style={{color: 'var(--danger)'}}>Failed to load badges.</p> : <Badges transactions={transactions} />}
